...
class Server:
    ...
    def login(self,sock):
        ...
        self.logger.log(logging.INFO,"Client " + str(client_number) + ". Usr:" + str(sub['usr']) + " - Pass:" + str(sub['psw']))   
    ...
    def matchDetail(self,sock):
        ...
        client_number = self.port_num_clients[sock.getpeername()[1]]
        self.logger.log(logging.INFO,"Client " + str(client_number) + ": ID trận đấu cần mở: " + id)
